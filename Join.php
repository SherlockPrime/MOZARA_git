<script language=javascript>
   ...
   cat2_name[4] = new Array('계양구','미추홀구(남구)','남동구','동구','부평구','서구','연수구','중구','강화군','옹진군');
   ...
   function cat1_change(key,sel){
      ...
      sel.options[i] = null;
      sel.options[0] = new Option('시(*)','', '', 'true');
...
<!--
                           <div class="1u 2u$(xsmall)">
                              <input type="text" name="adr" id="adrDo" value"" placeholder="도(*)" required />
                           </div>
                           <div class="1u 2u$(xsmall)">
                              <input type="text" name="adr" id="adrSi" value"" placeholder="시(*)" required />
                           </div>
                        -->
                        ...
                        <div class="2u 4u$(xsmall)">
                           ...
                           <div class="6u 12u$(xsmall)">
                              <input type="text" name="userAddr_det" id="userDet" value"" placeholder="상세주소(*)" required />
                                               ...
                                               <div class="12u$">
                                                  <ul class="actions">
                                                     <li><input type="submit" value="가입" class="special" /></li>
